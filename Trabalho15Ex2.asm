...
.text
	...
	Main:
		...
		readFile("dados2.txt", readFileBuffer)
		printInt($s1)
	...
	stringToIntVector: # Recebe em $a1 o endereço do primeiro elemento de uma String de inteiros separados por quebra de linha, cria um vetor de inteiros no endereço recebido em $a2 e retorna o comprimento desse vetor em $v1
		...
		loopStringToIntVector:
			...
			beq $t1, 10, nextIntStringToIntVector # Se o caracter na String for uma quebra de linha acontece termina de registrar o inteiro atual e vai para o próximo
			beq $t1, 13, loopStringToIntVector # Se o caracter na String for um sinal de controle antecede a quebra de linha ignora e vai para o próximo caracter
			...
			beq $t1, 32, errorStringToIntVector # Se o caracter na String for um espaço acontece um erro na função
